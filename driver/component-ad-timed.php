...
<!-- Mirrored from www.enableds.com/products/sticky/v53/component-ad-timed.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Mar 2023 18:32:47 GMT -->
<!-- Added by HTTrack -->
    ...
    <div id="page">
        ...
        <div class="page-content header-clear-medium">
            ...
            <div class="card card-style">
                <div class="card-body">
                    <p class="mb-1">
                        These ads are great when you want a user to see an advertisement for a specific amount of time.
                        You can easily customize the following parameters directly from HTML code.
                    </p>
            ...
            <a href="#" data-menu="ad-timed-2" data-timed-ad="10"
                class="btn btn-l btn-full rounded-s shadow-xl text-uppercase font-900 bg-highlight me-3 ms-3 mb-2">Show
                Full Ad</a>
            <a href="#" data-menu="ad-timed-1" data-timed-ad="5"
                class="btn btn-l btn-full rounded-s shadow-xl text-uppercase font-900 bg-highlight me-3 ms-3 mb-4">Show
                Modal</a>
            <a href="#" data-menu="ad-timed-3" data-timed-ad="5" data-auto-show-ad="20"
                class="btn btn-l btn-full rounded-s shadow-xl text-uppercase font-900 bg-highlight me-3 ms-3 mb-4">Shows
                Automatically in 10 Seconds</a>
        ...
        <div id="ad-timed-1" class="menu menu-box-modal rounded-m">
            <div class="card mb-0 bg-17" data-card-height="300">
                ...
                <div class="card-center ms-2 me-2">
                    ...
                    <p class="color-white text-center opacity-50 mt-n1 mb-0">Timed ads show for the amount of time you
                        want. During this time, users cannot click the close button. After the time has elapsed, the ad
                        can be closed.</p>
                    <a href="#"
                        class="close-menu me-3 ms-3 mt-5 btn btn-m btn-full rounded-s shadow-xl text-uppercase font-900 bg-red-dark">Demo
                        Close Button</a>
                </div>
        ...
        <div id="ad-timed-3" class="menu menu-box-modal menu-box-modal-full">
            <div class="card bg-17" style="height:100vh; width:100vw;">
                ...
                <div class="card-center ms-5 me-5">
                    ...
                    <p class="color-white text-center opacity-50 mt-n1 mb-0">This ad apears on it's own, and can only be
                        closed after 5 seconds. In the demo, you can use the red close button, in real life, you can
                        remove that button.</p>
                    <a href="#"
                        class="close-menu me-3 ms-3 mt-5 btn btn-m btn-full rounded-s shadow-xl text-uppercase font-900 bg-red-dark">Demo
                        Close Button</a>
                </div>
