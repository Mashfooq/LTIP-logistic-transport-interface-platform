...
$stm1 =$admin ->ret("SELECT * FROM `driverDetail` WHERE `driverID` = '$driverID'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <h4 class="m-0 font-weight-bold text-primary"><a href="index.php">HOME</a> / <a href="manage-driver.php">MANAGE</a> / UPDATE</h4>
            </div>
<div class="container">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Update Driver Details</h1>
                                    </div>
                                    <form action="admincontroller/manage-driver.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter driver Name..." value="<?php echo $row1['driverName']  ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="exampleInputText" name="driverEmail" aria-describedby="emailHelp"
                                                placeholder="Enter driver Email..." value="<?php echo $row1['driverEmail']  ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user"
                                                id="exampleInputText" name="driverPhone" aria-describedby="emailHelp"
                                                placeholder="Enter driver Phone..." value="<?php echo $row1['driverPhone']  ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea type="text" class="form-control form-control-user" id="exampleInputText" name="driverAddress" aria-describedby="emailHelp"
                                                placeholder="Enter driver Address..."  required><?php echo $row1['driverAddress']  ?></textarea>
                                        </div>
