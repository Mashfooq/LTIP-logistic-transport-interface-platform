...
if(isset($_GET['sellBirdID'])){
      ...
      $_SESSION['sellBirdID'] = $sellBirdID;
    }
    else{
...
var options = {
    ...
    "amount": "<?php echo $sellBirdPrice*100; ?>", // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
    "currency": "INR",
    ...
    "handler": function (response){
      ...
      window.location.href='admincontroller/manage-buy-bird.php'
    },
    "prefill": {
