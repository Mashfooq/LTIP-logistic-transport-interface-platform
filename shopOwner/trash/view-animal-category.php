<?php 
    ...
    elseif(!isset($_GET['animalCategoryID'])){
      $admin -> redirect('../admin/login');
    }
    else{
...
<!--JS below-->
  ...
  <div class="content-wrapper">
    ...
    <div class="row form-group" >
        ...
        <div class="col-sm-6" >           
          <a href="add-product.php"  class="btn btn-primary btn-sm float-right" >Add New Animal</a>
        </div>
    </div>
...
<?php 
  $stmt = $admin -> ret("SELECT * FROM `animal` WHERE `animalCategoryID` = '$animalCategoryID'");
