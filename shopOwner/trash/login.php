...
<body class="hold-transition login-page">
  <!-- <video  style="position:fixed;" autoplay muted width="100%" loop >
    ...
    <img style="position:fixed;" src="https://www.pinkpaws.co.in/wp-content/uploads/2020/07/banner4-Pet-store.jpg">
<div class="login-box">
  <!-- /.login-logo -->
    ...
    <div class="card-body">
      ...
      <form action="admincontroller/adminlogin.php" method="post">
        <div class="card-header text-center">
          <a href="" class="h1" style="color: black;"><b>WELCOME BACK</a>
        </div>
