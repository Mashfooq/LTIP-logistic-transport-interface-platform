  ...
  <div class="content-wrapper">
	...
	<table class="table">
              	...
              	<th scope="col">Date</th>
						...
						<tbody>
					  <?php
          $stmt = $admin -> ret("SELECT * FROM `contact_us` ORDER BY `cu_id` DESC");
          $i = 0;
        ...
        ?>
							...
							<td><?= $row['message'] ?></td>
							<td><?= $row['date']  ?></td>
							<td><a href="../Controller/admin/delete.php?dltquery=<?= $row['cu_id']; ?>"><button name="dlt" class="btn btn-danger">DELETE</button></a></td>
